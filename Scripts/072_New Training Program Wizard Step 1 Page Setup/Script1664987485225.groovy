...
WebUI.click(findTestObject('Object Repository/Page_Training Provider - Create new application/input_You have to submit a separate applica_5c08e6'))

WebUI.click(findTestObject('Object Repository/Page_Training Provider - Create new application/input_Blended_radio-buttons-0.6675957240916481-3'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_TP Application - Applicant Information/div_Enter applicant information'), 
    'Enter applicant information')

WebUI.verifyElementText(findTestObject('Object Repository/Page_TP Application - Applicant Information/h2_Enter applicant information'), 
    'Enter applicant information')
