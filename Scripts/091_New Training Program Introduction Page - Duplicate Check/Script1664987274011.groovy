...
WebUI.click(findTestObject('Object Repository/Page_Training Provider - Create new application/input_You have to submit a separate applica_d40b56'))

WebUI.click(findTestObject('Object Repository/Page_Training Provider - Create new application/input_Blended_radio-buttons-0.5562938137709188-3'))
