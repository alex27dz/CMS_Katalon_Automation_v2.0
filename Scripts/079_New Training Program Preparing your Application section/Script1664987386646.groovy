...
WebUI.click(findTestObject('Object Repository/Page_Training Provider - Create new application/input_You have to submit a separate applica_751051'))

WebUI.click(findTestObject('Object Repository/Page_Training Provider - Create new application/input_Blended_radio-buttons-0.8489884766618552-3'))
