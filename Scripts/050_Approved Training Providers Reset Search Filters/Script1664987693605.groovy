...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Marketplace - Approved Provider List/button_Reset filters'))

WebUI.click(findTestObject('Object Repository/Page_Marketplace - Approved Provider List/button_Reset filters'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Marketplace - Approved Provider List/div_Showing 0 providers information'), 
    'Showing 0 providers information')
