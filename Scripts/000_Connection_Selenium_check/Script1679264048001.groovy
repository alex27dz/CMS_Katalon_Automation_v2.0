...
WebUI.click(findTestObject('Object Repository/Page_mazda - Google Search/span_Mazda Canada - Build Yours'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_/h2_BUILD  PRICE'), 'BUILD & PRICE')
