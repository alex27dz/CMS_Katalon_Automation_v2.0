...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Prevention Landing Page - Home/div_Safety  Prevention'), 
    'Safety & Prevention')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Prevention Landing Page - Home/div_All workers have the right to return ho_1d8493'), 
    'All workers have the right to return home each day safe and sound.')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Prevention Landing Page - Home/div_Working to prevent workplace injuries a_8fc2b8'), 
