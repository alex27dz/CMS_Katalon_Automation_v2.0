...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Training Provider - Program Summary/button_Submit training program delivery app_2ec0f1'), 
    'Submit training program delivery application')

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Training Provider - Program Summary/button_Submit training program delivery app_2ec0f1'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Training Provider - Create new application/h2_Application for new training program delivery'), 
    'Application for new training program delivery')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Training Provider - Create new application/span_Please select the language that you wa_612217'), 
    'Please select the language that you want to deliver the training in?')

WebUI.rightClick(findTestObject('Object Repository/Page_Training Provider - Create new application/span_Please select the training format that_632255'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Training Provider - Create new application/span_Please select the training format that_632255'), 
    'Please select the training format that you want to deliver the training in?')
